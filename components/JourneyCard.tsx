    ...
    >
      ...
      {isDirect ? (
        ...
        <div
          ...
          className="space-y-3 py-1 cursor-pointer"
        >
              ...
              <div className="flex items-center justify-between pr-2">
                ...
                {onTrackTrain && (
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      onTrackTrain(leg1.trainNumber, leg1.trainName);
                    }}
                    className="px-2 py-0.5 rounded-md bg-cyan-950/90 hover:bg-cyan-900 border border-cyan-500/40 text-[10px] font-bold text-cyan-300 flex items-center gap-1 transition-colors"
                  >
                    <Train className="w-3 h-3 text-cyan-400" /> Track
                  </button>
                )}
              </div>
            </div>
              ...
              <div className="flex items-center justify-between pr-2">
                ...
                {onTrackTrain && (
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      onTrackTrain(leg2.trainNumber, leg2.trainName);
                    }}
                    className="px-2 py-0.5 rounded-md bg-cyan-950/90 hover:bg-cyan-900 border border-cyan-500/40 text-[10px] font-bold text-cyan-300 flex items-center gap-1 transition-colors"
                  >
                    <Train className="w-3 h-3 text-cyan-400" /> Track
        ...
        <div className="flex items-center gap-2">
          ...
          {onTrackTrain && (
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-cyan-950/90 hover:bg-cyan-900 border border-cyan-500/40 text-[11px] font-bold text-cyan-300 transition-colors shadow-sm"
            >
